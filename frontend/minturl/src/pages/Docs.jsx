              ...
              <div className="rounded-xl border border-slate-100 overflow-hidden">
                ...
                <div className="p-5 space-y-3">
                  {[
                    ...
                    { step: 'Output', value: 'http://localhost:8080/abc123' },
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    a: 'Edit the baseURL value in src/api/api.js from http://localhost:8080/api to your backend\'s address.',
                  },
                ].map((item) => (
